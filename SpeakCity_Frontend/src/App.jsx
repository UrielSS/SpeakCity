        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <ul style={{ listStyle: "none", padding: 0 }}>
              {["Abrir Cerrar la calle V11", "Cambia a rojo el semaforo de arriba de la intersección I22", "Establece a 8 segundos el semaforo derecho de la interseción I22", "Abre todas las calles cerradas"].map((item, index) => (
                <li key={index} style={{
                  display: "flex",
                  alignItems: "center",
